...
# 產生測試的 logs 至 otel-collector
podman-compose run telemetrygen logs --duration 10s --otlp-insecure --otlp-endpoint otel-collector:4317

# 產生測試的 metrics 至 otel-collector
podman-compose run telemetrygen metrics --duration 10s --otlp-insecure --otlp-endpoint otel-collector:4317
```
